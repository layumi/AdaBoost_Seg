...
def main():
    ...
    targetloader2_shuffle = data.DataLoader( robotDataSet(args.data_dir_target, args.data_list_target, max_iters=target_number*3, crop_size=(480, 960), resize_size=(1280, 960), mean=IMG_MEAN, scale=True, mirror=True, set='train'),
